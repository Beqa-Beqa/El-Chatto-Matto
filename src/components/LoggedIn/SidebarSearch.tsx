...
import { DocumentData, arrayUnion, collection, doc, getDocs, query, setDoc, updateDoc, where } from "firebase/firestore";
import { AuthContext } from "../../contexts/AuthContextProvider";
import { combineIds, filterUsername } from "../../functions";
...
const SidebarChats = () => {
  ...
  const handleUserClick = async (targetUserData: DocumentData) => {
    try {
  ...
  return (
    <div>
      ...
      {userName && userData.map((data: DocumentData, key: number) => {
